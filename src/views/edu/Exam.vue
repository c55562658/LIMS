            ...
            <el-timeline>
                <el-timeline-item v-bind:timestamp="question.created" placement="top" v-for="question in questions">
                    <el-card>
                        ...
                        <el-button @click="toAnswer(question.topicType)" type="primary" round>开始答题</el-button>
                    </el-card>
                </el-timeline-item>
            </el-timeline>
...
export default {
    ...
    created() {
        const _this = this
        this.page(1);
        _this.$axios.post("/edu-result/queryOneExamResult", {
    ...
    methods: {
        ...
        toAnswer(topicTypeToAnswer) {
            this.$router.push({ path: "/edu/answer", query: { topicType: topicTypeToAnswer } })
